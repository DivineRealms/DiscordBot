...
module.exports.config = {
  settings: {
    ...
    changingActivity: {
      //An activity that automatically updates
      enabled: true,
  ...
  automation: {
    ...
    Booster_Message:
      "Thank you {member} for boosting the server! We now have {boosters} booster(s)!",
  ...
  counting: {
    ...
    Wrong_Number_Message:
      "Wrong number {username}, The current number is {number}!",
    One_At_A_Time: false,
    One_At_A_Time_Message:
      "Sorry {username}, but you can only say a number one at a time!",
  ...
  leveling: {
    ...
    level_Up_Roles: [
      //roles to award when members reach a certain level
  ...
  ticketSystem: {
    ...
    Ticket_Message:
      "Thank you for creating a ticket {username}, a staff member will be with you shortly.",
    Support_Team_Roles: ["747258761466609714", "734736802384052264"],
    Panel_Emoji: "✉️",
    Panel_Title: "Create a Ticket",
    Panel_Message:
      "Please react with the emoji to create a ticket\nA staff member will be with you shortly.",
  ...
  welcomeSystem: {
    ...
    welcomeCardBackGroundURL:
      "https://minecraft-mp.com/images/banners/banner-295045-1636327342.png",
    welcomeMessage:
      "Welcome {member} to the server, You are our {joinPosition} member!",
    welcomeDM:
      "Welcome {member} to the server! You are our {joinPosition} member!",
    welcomeEmbed: {
  ...
  birthdaySystem: {
    ...
    birthdayMessage:
      "Happy birthday to the following member(s)! Make sure to wish them a happy birthday in general!",
  },
  economy: {
    enabled: true,
    shopItems: [
