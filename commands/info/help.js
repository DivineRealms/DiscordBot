...
module.exports.run = async (client, message, args) => {
  ...
  if (!cmd) {
    const mainMenu = client.embedBuilder(
      client,
      message,
      "Help Menu",
    ...
    const ecoEmbed = client.embedBuilder(
      client,
      message,
      "Economy Commands",
      economy
    ...
    const infoEmbed = client.embedBuilder(
      client,
      message,
      "Info Commands",
      info
    ...
    const modEmbed = client.embedBuilder(
      client,
      message,
      "Moderation Commands",
      moderation
    ...
    const ticketsEmbed = client.embedBuilder(
      client,
      message,
      "Tickets Commands",
      tickets
    ...
    const utilEmbed = client.embedBuilder(
      client,
      message,
      "Utility Commands",
      utility
