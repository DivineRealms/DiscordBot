...
module.exports.run = async(client, message, args) => {
  ...
  if(cooldown != null && day - (Date.now() - cooldown) > 0) return message.channel.send({ embeds: [client.embedBuilder(client, message.author, "You're on cooldown, try again later.", "", "error")] });
