...
module.exports.run = async(client, message, args) => {
  if (!args[1]) return message.channel.send({ embeds: [new client.embedBuilder(client, message, "Error", `Please specify your question`)]})
  ...
  message.channel.send({ embeds: [new client.embedBuilder(client, message, "8ball", `
  **Question**: ${args.join(' ')}
