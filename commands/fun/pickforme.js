...
module.exports.run = async(client, message, args) => {
    ...
    if (!choice) return message.channel.send({ embeds: [new client.embedBuilder(client, message, "Error", `You need to give me choices separated with a \`|\`\nExample \`${message.px}pickforme apple | banana | peach\`!`)]})
