...
module.exports.run = async(client, message, args) => {
  ...
  if (!choice) return message.channel.send({ embeds: [client.embedBuilder(client, message, "You need to give me choices separated with a \`|\`\nExample \`${message.px}pickforme apple | banana | peach\`!", "", "error")]})
